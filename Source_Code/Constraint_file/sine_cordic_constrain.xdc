...
# Switches
set_property PACKAGE_PIN V17 [get_ports {freq_reg[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[0]}]
set_property PACKAGE_PIN V16 [get_ports {freq_reg[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[1]}]
set_property PACKAGE_PIN W16 [get_ports {freq_reg[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[2]}]
set_property PACKAGE_PIN W17 [get_ports {freq_reg[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[3]}]
set_property PACKAGE_PIN W15 [get_ports {freq_reg[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[4]}]
set_property PACKAGE_PIN V15 [get_ports {freq_reg[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[5]}]
set_property PACKAGE_PIN W14 [get_ports {freq_reg[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[6]}]
set_property PACKAGE_PIN W13 [get_ports {freq_reg[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[7]}]
set_property PACKAGE_PIN V2 [get_ports {freq_reg[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[8]}]
set_property PACKAGE_PIN T3 [get_ports {freq_reg[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[9]}]
set_property PACKAGE_PIN T2 [get_ports {freq_reg[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {freq_reg[10]}]
...
set_property PACKAGE_PIN H1 [get_ports {cs}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cs}]
#Sch name = JA8
set_property PACKAGE_PIN K2 [get_ports {data}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {data}]
#Sch name = JA9
